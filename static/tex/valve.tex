...
\begin{tikzpicture}
   ...
   \end{tabular} 
    ...
    \path[-{>[scale=2.5, width=3]},line width=0.4pt]
     ...
     (opening) edge[bend left=20] 
       node[anchor=north,above,rotate=40]{\fontfamily{pcr}\selectfont \small can\_close} (closing)                       
     ...
     (closing) edge[bend left=20] 
       node[anchor=south,below,rotate=40]{\fontfamily{pcr}\selectfont \small can\_open} (opening)       
